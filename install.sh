...
sudo sed -i -e 's/Environment="JENKINS_PORT=[0-9]\+"/Environment="JENKINS_PORT=8086"/' /usr/lib/systemd/system/jenkins.service
#sudo sed -i -e 's/JENKINS_LISTEN_ADDRESS=[0-9]\+"/JENKINS_LISTEN_ADDRESS="0.0.0.0""/' /etc/sysconfig/jenkins
